      ...
      <div className="bg-white p-6 rounded-3xl border border-gray-100/50 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-6 relative">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto border-t md:border-t-0 pt-4 md:pt-0">
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-[#22C55E] hover:bg-[#16A34A] text-white px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 shadow-sm cursor-pointer"
          >
          ...
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-rose-50 hover:bg-rose-100 text-rose-600 px-5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 shadow-sm cursor-pointer"
          >
        ...
        <div className="bg-white border border-gray-100/50 shadow-sm rounded-3xl h-[400px] overflow-hidden flex flex-col justify-between">
          ...
          <form onSubmit={handleSendMessage} className="p-3 bg-white border-t border-gray-100 flex items-center gap-2">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-50 border border-gray-100 rounded-xl text-xs outline-none focus:border-[#016EA6] focus:bg-white transition-all"
            />
            <button type="submit" className="p-2.5 bg-[#016EA6] hover:bg-[#061EA6] text-white rounded-xl shadow-xs transition-all active:scale-95 flex items-center justify-center shrink-0 cursor-pointer">
