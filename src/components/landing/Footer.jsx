        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 md:gap-12 relative z-10 w-full mb-12 md:mb-16">
          ...
          <div className="lg:col-span-6 flex flex-col gap-6 max-w-xl">
            ...
            <p className="text-white/80 text-sm md:text-base leading-relaxed">
              Whether it's home repairs, cleaning, renovations, or digital solutions, Linkprosoft connects you with trusted experts quickly, securely, and hassle-free.
            </p>

            {/* Search capsule form */}
            <form onSubmit={handleSearchSubmit} className="bg-white backdrop-blur-md border border-white/20 p-2 rounded-full flex items-center w-full max-w-md shadow-inner mt-2">
              <input
                type="text"
          ...
          <div className="lg:col-span-6 grid grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h4 className="font-bold text-base tracking-wide text-white/90">Company</h4>
            ...
            {/* Column 2: Services */}
            <div className="flex flex-col gap-4">
              <h4 className="font-bold text-base tracking-wide text-white/90">Services</h4>
              <ul className="flex flex-col gap-3 text-xs md:text-sm text-white/70">
                ...
                <li><Link to="/services/carpentry" className="hover:text-white transition-colors">Carpentry</Link></li>
                <li><Link to="/services/digital" className="hover:text-white transition-colors">Digital Solutions</Link></li>
              </ul>
            </div>

            {/* Column 3: Support */}
            <div className="flex flex-col gap-4">
              <h4 className="font-bold text-base tracking-wide text-white/90">Support</h4>
              <ul className="flex flex-col gap-3 text-xs md:text-sm text-white/70">
