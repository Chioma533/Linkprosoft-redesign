...
// Custom confetti colors for the success page
...
const ResetSuccess = ({ onDashboardRedirect }) => {
  return (
    <motion.div
    ...
    >
      ...
      <div className="w-full bg-white rounded-3xl border border-gray-100 shadow-xl p-8 md:p-10 flex flex-col items-center text-center relative z-10">
        {/* Envelope and Key Icon (Custom Vector Design matching screenshot) */}
        <div className="w-40 h-32 relative flex items-center justify-center mb-6">
          ...
          >
            ...
            >
              {/* Blue Card with Key icon inside a circle */}
              <rect x="45" y="25" width="70" height="55" rx="8" fill="#016EA6" />
              <circle cx="80" cy="50" r="14" fill="#01527C" />
              {/* Key Icon inside popping card */}
              <path
                d="M76 46C73.8 48.2 73.8 51.8 76 54C77.4 55.4 79.4 55.8 81.2 55.2L85 59V61H87V59H89L89 57L86 54C86.6 52.2 86.2 50.2 84.8 48.8C82.6 46.6 79 46.6 76 46ZM78 48C79.1 48 80 48.9 80 50C80 51.1 79.1 52 78 52C76.9 52 76 51.1 76 50C76 48.9 76.9 48 78 48Z"
                fill="white"
              />
            </motion.g>
        ...
        <p className="text-gray-400 text-sm font-light mb-8 max-w-[300px] leading-relaxed">
          Your password has been reset successfully you can go to dashboard now
        </p>
