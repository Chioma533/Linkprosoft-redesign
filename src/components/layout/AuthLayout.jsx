...
import WorkerImage from "../../assets/images/handyman.jfif";
   ...
   <motion.div
    ...
    >
      ...
      <div className="hidden md:block w-1/2 relative aspect-[4/5] rounded-[2.5rem] overflow-hidden group shadow-md">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/85 via-black/35 to-black/5 flex flex-col justify-end p-8 text-white">
          ...
          <p className="text-sm font-light leading-relaxed text-gray-200">
            &ldquo;I&apos;ve worked with different clients through Linkprosoft, and it&apos;s been very organized. I know exactly what is expected before I arrive.&rdquo;
          </p>
        </div>
      </div>
